          ...
          <div className="content-section">
            ...
            <div className="infoColumn">
              ...
              <div className="movieInfo">
                Director :
               <Directors directors={movieCast?.crew}></Directors>
              </div>

              <div className="movieInfo">
                Writers :
                <Writer writer={movieCast?.crew}></Writer>
              </div>
              ...
              <div className="castList">
                <MovieCastsComponent movieCast={movieCast?.cast} ></MovieCastsComponent>
              </div>

              {/* <MovieTrailer embedId={`${movieInfo.videos.results[0].key}`} /> */}
              <div className="movieInfo">TRAILER </div>
              <MovieTrailer movieTrailer = {movieInfo?.videos.results}></MovieTrailer>
            </div>
          </div>
        </>
      ) : (
