    ...
    <>
      <div className="castDetails">
        <div className="left-col">
          ...
          />
          <div className="title">Personal infomation
          <dl>
            <dt>Job</dt>
            <dd className="light-text">{castDetail?.known_for_department}</dd>
            <dt>Gender</dt>
            {castDetail?.gender == "1" ? <dd className="light-text">Women</dd> : <dd className="light-text">Men</dd>}
            <dt >Day of birth</dt>
        ...
        <div className="right-col">
          <div className="actor-name margin-2" >
            {castDetail?.name}
          </div>
          <h4 className="font-600 margin-2">
            About
          </h4>
          <div className="light-text margin-2">
          ...
          <div className="movie-participated" >
            <CastParticipated participates={castDetail?.credits.cast}> </CastParticipated>
          </div>
        </div>
      </div>
    </>
